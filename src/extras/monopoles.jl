...
analytical expressions for consistency with [`CreateRankine`](@ref).
"""
...
the vorticity fields generated by [`Create1LMonopole`](@ref). It does not support multi-layer QG
